...
# * Bu versiyonda NaN değerler sınıf kırılımlarına göre doldurulmuştur
#######################################
...
df.isna().sum()
df['Salary'] = df['Salary'].fillna(df.groupby(
    ['League', 'Division', 'NewLeague'])['Salary'].transform('mean'))
